...
curve(v.f(x, cov.pars = c(1, 1.232), kappa = 0.5, cov.model = "sph"), 0, 2,
     lty = 2, ylab = "Covariogram",xlab = expression(paste("Distance ", (tau))),
     main = "Spherical")
legend("topright", legend=expression(paste(phi, " = 1.232")), lty=2)
...
legend("topright", legend = expression(paste(phi, " = 0.229")), lty = 1, col = "red")
...
curve(sv.f(x, cov.pars = c(1, 1.232), kappa = 0.5, cov.model = "sph"), 0, 2,
      lty = 2, ylab = "Covariogram",xlab = expression(paste("Distance ", (tau))),
      main = "Spherical")
legend("bottomright", legend=expression(paste(phi, " = 1.232")), lty=2)
